...
\include{text/Methods/cell_methods}
\include{text/Pipelines/workflow_generation}
\include{text/bulk_MAZ_NCP/bulk}
\include{text/single-cell_PRS/sc}
...
% Methods
% Workflow generation
% Systems approaches, WT vs aBTZ vs aCFZ (cell line model) (maybe WT vs WT carf as well, how carf usually works)
% TRIM24i reversal. everything separate and then integrate.
