...
\title{Using a multi-omics approach to understand the mechanisms controlling proteasome inhibitor resistance in multiple myeloma, and using epigenetic inhibitors to reverse resistance}
...
\include{text/Results_1/results}
