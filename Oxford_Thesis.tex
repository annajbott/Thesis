...
\addbibresource{references/bib_lit.bib}
...
\title{Using a multi-omics approach to identify novel therapeutics in multiple myeloma capable of overcoming drug resistance}
...
\flushbottom
\include{text/Chapter_1/ch1-intro}
\include{text/Chapter_2/ch2-litreview}
\include{text/Chapter_3_Methods/cell_methods}
\include{text/Chapter_4_Pipelines/workflow_generation}
%\include{text/Chapter_4_Pipelines/tRNA_methods}
%\include{text/Chapter_4_Pipelines/MM_classifier}
\include{text/Chapter_5_bulk_MAZ_NCP/bulk}
\include{text/Chapter_6_single-cell_PRS/sc}
%\include{text/Chapter_7_trna_PRS/trna}
%\include{text/Chapter_8_TRIM24i/trim24i}

%\include{text/Results_dose/results_dose}
%\include{text/Results_multi-omics/results}
%\include{text/Systems approaches/system_approaches}
%\include{text/TRIM24i reversal/trim24i_reversal}
