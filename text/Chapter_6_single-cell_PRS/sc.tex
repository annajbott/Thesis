...
\begin{figure}[p]
    ...
    a) Seurat UMAP feature plots showing MM marker expression.
    Grey indicates no expression and purple indicates expression.
    b) A dot plot showing for each cluster the percentage of cells expressing a given marker and the average expression.
    c) Violin plots showing gene expression for each cluster.}
...
There is insufficient evidence (p>0.05) to conclude if Halofuginone treatment affected the proportion of cells in the MM cluster.
