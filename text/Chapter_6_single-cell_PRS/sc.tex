...
GCN2 has been shown to have an important role in myeloid cell homeostasis and immune function\cite{halaby2019gcn2,ravishankar2015amino}.
...
In fact, Ravishankar et al. (2015)
GCN2 has been suggested to be a critical mediator of apoptosis vs autophagy during inflammation.
% Thus, GCN2 may be a critical apoptosis/autophagy checkpoint during inflammation. live or die
One of the many roles of macrophages is clearance of apoptotic cells\cite{gordon2018macrophage}.
...
A decrease in the number of functional myeloid cells could lead to myeloid suppression (myelosuppression/ bone marrow suppression), which in turn makes patients more prone to infection.
...
Preferential selectivity of ProRS inhibitors for MM cells should be confirmed using dose-response experiments, using MM cells and MM patient-derived immune cells, separated into their constituent cell types. % FACS?
This should be performed with and without apoptotic cells present.
...
Differential expression analysis of relapsed MM subclonal clusters (cluster 4 vs cluster 9) revealed signature markers of drug-resistance.
