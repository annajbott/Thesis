...
This was expected as MM patients' transcriptomes have been shown to change considerably following successive rounds of treatment cycles.
That is, the datasets were too different to identify good anchors between them.
Therefore, samples from experiments 1 and 2 (patients 1 and 2: treatment-naive) were integrated together and samples from experiment 3 (patients 3 and 4: relapsed) were integrated together.
...
The relapsed patients demonstrate substantial transcriptional differences to treatment-naive patients, in both their myeloma cells and their immune microenvironment.
...
This \textit{CD138}\textsuperscript{-} subclone of MM cells would have been removed if \textit{CD138}\textsuperscript{+} enrichment techniques were used prior to sequencing.
...
Clusters 4 and 9 in the relapsed MM dataset were identified using gene expression data and inferCNV analysis.
Cells in cluster 9 were shown to express no CD138 or very little CD138.
...
Stem cell CD138- MM cells, resistant to drugs.
More research include whole BM niche, not just CD138+ fraction.
MM classifier can simplify process of MM identification.

Drugs showed little effect on cluster 9. Could be key to MRD and clonogenic. Naive patient showed large CD138+ MM expression. Difference between naive and relapse
Argument for sequencing whole BM niche.
Also if just sequenced MM cells (CD138+) would miss effects on myeloid cells.
...
more time tRNA optimise
more time, test drugs on myeloma patient PBMCs, and split into immune cell type