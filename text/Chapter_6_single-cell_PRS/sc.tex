...
By being able to account for the different covariates in the integration, Harmony was found to integrate clusters across patients and experiments better than using Seurat's SCTransform.
Integration results from Seurat's SCTransform gave clusters that were very distinct for each experiment/patient, whereas Harmony seemed to mix experiments together better.
...
Together with dose response curves and cell death assays, this suggests that HF and NCP26 are selectively killing MM cells to a higher degree than most other cell types.
...
HF treatment and 24-hour NCP26 treatment were also found to reduce the proportion of cells in the monocyte and neutrophil cluster (p<0.00001), indicating they may have some undesirable effects on other healthy cell types.
...
On the other hand, as we've seen in MM, ProRS inhibitors are more selective and effective against malignant MM cells than for healthy plasma cells.
This could also be the case for ProRS inhibitors and malignant myeloid cells versus healthy myeloid cells.
Given that HF and NCP26 were shown to kill healthy myeloid cells in MM patients, they could be even more effective against malignant myeloid cells.
Thus, ProRS inhibitors could represent a potential therapeutic for treatment of acute myeloid leukaemia (AML).
AML is an aggressive cancer of myeloid cells, with poor patient outcomes (with more than 50\% of patients ultimately dying from their disease)\cite{NHSAML,short2018acute}.
Approximately 3000 new cases of AML are reported each year in the UK\cite{cancerresearchukAMLincidence}.
Novel therapeutics for AML are required to improve patient outcomes.
The effectiveness of ProRS inhibitors should be investigated in AML cell lines and AML patient samples, including PBMCs from AML patients to determine selectivity over healthy immune cells.
If ProRS inhibitors were effective against AML, this could unlock a whole new use-case for this drug class, and improve the prognoses of even more cancer patients.
