...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Results/single_cell/data_processing/clustifyr_scclassify_annotation.pdf}
...
Text about how they give a pretty good idea of which cluster is which, but need to delve deeper with biological knowledge.
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Results/single_cell/data_processing/mm_markers_ABC.pdf}
