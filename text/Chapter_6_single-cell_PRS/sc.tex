...
However, monocytes also have

% NCP26 HF more selective for MM cells
...
MM cells have a large number of DEGs for NCP26 treated samples, and HF-treated in experiment 2.
In contrast, many of the other immune cell types, for example T and B cells, have much fewer genes differentially expressed by NCP26 treatment (figure \ref{fig:naive_deg_bar}).
This supports

HF dosing too high, IC50 etc. Kill off MM cells and myeloid cells, at this dosing range see more T cells with high numbers of DEGs, etc.
