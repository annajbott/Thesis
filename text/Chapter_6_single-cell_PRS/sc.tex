...
Differential expression and pathway enrichment analysis was performed for NCP26 and HF treatment in the myeloid clusters, to explore the transcriptional effect of ProRS inhibition in myeloid cells.
Cell cycle arrest, apoptosis and ER-stress responses were enriched in ProRS inhibitor treated samples.
...
From the results it is clear that, at the given concentrations,  NCP26 and HF treatment adversely affected myeloid cells.
...
Furthermore, the control PBMCs originated from healthy donors and not from the immune microenvironment of MM patients.
...
% https://onlinelibrary.wiley.com/doi/10.1002/jbt.22894
PI, MG132, shown to induce macrophage apoptosis by promoting the production of ROS and mitochondrial dysfunction.
% proteasome inhibition induced cell oxidative stress in macrophages.
Might not limit ProRS inhibitor application


% cellular oxidation?
% Inversely the effects may not be cytotoxicity
% Interesting to see if other aaRS inhibitors had same effect on myeloid cells.
% Could it be macrophages that have negative impact on treatment anyway? Good thing then.

\subsection{Resistant relapsed MM cluster}


\subsection{Whole bone marrow scRNA-seq}
...
The cells belonging to cluster 9 were shown to express very little or no \textit{CD138}.
...
Cluster 9 was found to be mostly resistant to NCP26 and HF treatment.
...
Investigate potency and dose response in PBMCs from MM patients, separated by cell type using FACs??