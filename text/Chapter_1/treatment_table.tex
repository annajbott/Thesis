...
\end{tabular}
\caption[Timeline of multiple myeloma treatment options]{Timeline of treatment options for multiple myeloma (MM). Listed by first usage or approval for MM in any country. USA FDA approved drugs not all approved yet in the UK. PI= proteasome inhibitor, BM= bone marrow, RRMM= relapsed and refractory MM.}
