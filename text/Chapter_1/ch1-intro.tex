...
Immunoglobulins (Ig) are large Y-shaped proteins, consisting of two heavy chains and two light chains (Figure \ref{fig:immunoglobulins_diagram}a).
%%
%% Antibody figure
\begin{figure}[htb]
...
Humans produce five isotypes of immunoglobulins: IgM, IgD, IgG, IgA and IgE (named after their heavy chain type; Figure \ref{fig:immunoglobulins_diagram}b).
Igs can either be membrane-bound (mIgs) on the cell-surface or secreted (sIgs).
mIgs are components of B-cell receptors (BCR) \cite{friess2018structural}\@.
Newly formed B cells insert their first Igs into their plasma membrane, where they act as BCRs.
Developing B cells always produce IgM first and form BCRs from IgM molecules.
As these cells develop, they start to form BCRs from IgD too.
