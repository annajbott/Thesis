...
Another avenue to increase patient survival, would be to identify novel therapeutics, effective against MM, which are capable of overcoming acquired anti-cancer drug resistance.
Therapeutics with a novel mechanism of action are likely to be more effective for relapsed and refractory MM (RRMM) patients than new drugs belonging to the same class of drug as a drug they have previously been treated with.
This is because there would be less overlap of mechanisms of action.
