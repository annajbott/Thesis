...
As these cells develop and leave the bone marrow, they start to form BCRs from IgD molecules too.
Each of these mature naive B cells IgM and IgD BCRs will contain the same antigen-binding site, but with different constant heavy chain types.
...
Only upon antigenic stimulation can B cells produce the secondary class of Igs: IgD, IgA and IgE\@.
