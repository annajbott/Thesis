...
%% To do:
% MM MGUS SMM immune paper, ribosome, sanger sequencing
...
In Sanger sequencing, or the `chain termination method', chain-termination PCR is performed with a mix of regular nucleotides (deoxynucleotide triphosphates; dNTPs) and fluorescently-or radiolabelled, chain-terminating dNTPs (dideoxynucleotide triphosphates; ddNTPs), using the DNA of interest as a template.
...
With NGS one can rapidly sequence the entire human genome in one day, for under \$5000.
...
Bulk RNA-seq is employed and the transcriptional landscape following ProRS treatment and ProRS resistance is characterised.
