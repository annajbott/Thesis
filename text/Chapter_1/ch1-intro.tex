...
Plasma cells have an extensive rough endoplasmic reticulum (ER), and have numerous genes involved in antibody secretion upregulated, including \textit{XBP1} and \textit{DDIT3}, to enable the production of copious amounts of antibody\cite{shapiro2004plasma}.
...
Plasma cells have reduced proteasome capacity and have an increased proteasomal workload\cite{bianchi2009proteasome}.
Fewer functional proteasomes with an increased workload generates an imbalance, which predisposes plasma cells to apoptosis if additional ER stressors are added\cite{bianchi2009proteasome}.
This is why
...
Often sections of DNA are denoted as their sequence of A, C, T and Gs (in order reading from the 5' to 3' direction)\cite{alberts2007DNAstructure}.
...
Tight coiling of this fiber forms the single chromatids of chromosomes.
Human cells contain 23 pairs of chromosomes\cite{annunziato2008dna, alberts2002chromosomal}.
...
Epigenetic changes include histone modifications, DNA methylation and chromatin remodelling\cite{alberts2007chromatin}.
...
They include methylation, acetylation, phosphorylation, ubiquitination and sumoylation\cite{alberts2007chromatin}.
...
However, unlike DNA, RNA is single-stranded, it contains the sugar ribose in place of deoxyribose, and the nucleotide uracil (U) in place of thymine (T)\cite{alberts2007transcription}.
...
Just behind the region where ribonucleotides are being added, the DNA helix reforms\cite{alberts2007transcription}.
...
Instead, the sequence of mRNA is read in groups of three consecutive nucleotides, called a codon\cite{alberts2007mRNA}.
...
Eukaryotic cells contain millions of ribosomes in their cytoplasm\cite{alberts2007mRNA}.
...
The peptide chain grows until a stop codon is reached and synthesis of the current protein is complete\cite{alberts2007mRNA}.
...
The whole project took approximately 13 years to complete, and was reported to have cost \$3 billion\cite{genomeHGP}.
...
Using NGS, one can rapidly sequence the entire human genome in one day, for less than \$4000\cite{genomeHGPcosts}.
...
Today, the largest and most commonly used NGS sequencing technology platform is Illumina, who own around 80\% of the global sequencing market\cite{illuminamarket}.
