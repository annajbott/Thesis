...
DNA packaging is a complex tasking involving numerous speciliased proteins:
...
\end{subfigure}
    ...
    DNA is wrapped 1.65 times around an octomer of histone proteins, to form a stucture called a nucleosome.
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figures_made/drop_seq.png}
