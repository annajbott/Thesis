...
Patients follow a pattern of peaks and troughs of treatment cycles, remission and relapse, until all therapies have little effect.
In order to overcome resistance and increase overall survival of MM patients, the molecular mechanisms of resistance to proteasome inhibitors needs to be understood. This  will aid in the design of novel therapies and inform better use of existing therapies.
...
Other upregulated genes have been identified, for example \textit{ABCB1}, coding for P-glycoprotein, responsible for pumping various substrates out of the cell, often referred to as the multidrug resistant protein 1.
...
Identifying novel therapeutics effective against MM is of critical importance.
...
Chapter \ref{ch:6-sc} investigates ProRS inhibitor treatment of primary BM samples from MM patients at the single cell level.
Newly-diagnosed and relapsed MM patient tissue is assessed.
Chapter \ref{ch:7-trna} describes the changes seen in tRNA ... following ProRS inhibition.
