...
After antigen stimulation, mature naive B cells are activated to become Ig-secreting effector cells (plasma cells).
...
Initially, effector B cells will only secrete primary Igs (IgM and IgD), and with low binding affinity for antigens.
