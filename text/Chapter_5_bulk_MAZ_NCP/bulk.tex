...
This perhaps indicates that there is an epigenetic aspect to NCP26's mechanism of action.
ATAC-seq or ChIP-seq could be performed for NCP26 treatment and NCP26R cells to investigate this further.
A number of immune pathways were also found to be suppressed in NCP26R cells, many involving MHC protein complexes and antigen binding.
This could be to reduce recognition and subsequent cytotoxicity of CD8+ T cells, this is a major mechanism by which tumour cells evade anti-tumor immunity\cite{cornel2020mhc}.
ER-associated pathways were also found to be suppressed in NCP26R cells, including `integral component of lumenal side of endoplasmic reticulum membrane', `ER to Golgi transport vesicle membrane', `endoplasmic reticulum lumen'.
...
Cancer is known to adapt to therapy, changing its gene expression and genetic make-up to overcome drug treatment.
...
Therefore, metabolic reprogramming to increase intracellular proline levels would be a very simple way for cancer cells to adapt and overcome HF's cytotoxic effects.
...
Plasma cells and MM cells have an increased proteasome workload, likely due to the metabolic strain associated with synthesising antibodies and paraprotein, additionally plasma cells have reduced proteasome capacity\cite{bianchi2009proteasome}.
Together, this predisposes plasma cells to apoptosis from additional ER stressors, and makes them sensitive to proteasome inhibitors\cite{bianchi2009proteasome}.
...
Bortezomib-treated flies supplemented with excess amino acids saw markedly increased survival, without affecting polyubiquitinated protein levels (that is, not affecting proteome efficiency).
...
%Additionally, plasma cells and MM cells have an increased proteasome workload, likely due to the metabolic strain associated with synthesising antibodies and paraprotein\cite{bianchi2009proteasome}, predisposing them to ER stress and apoptosis.
...
Conversely, GCN2 inhibition (rather than activation) has also been investigated as an anti-MM therapeutic strategy.
Using longitudinal dscRNA-seq analyses of V$\kappa$\textsuperscript{*}MYC MM mice, Croucher et al. (2021) found that GCN2 and ISR pathways contributed to molecular malignant programmes underpinning sub-clonal tumour heterogeneity and disease progression in MM\cite{croucher2021longitudinal}.
They also found that high GCN2 activity was related to early disease, perhaps indicating it as a protective mechanism employed by MM cells to cope with increased cellular stress.
The group then investigated two publically available datasets of bulk RNA-seq and scRNA-seq MM data, and similarly found a progressive increase in ISR-GCN2 gene signature scores across disease stages from MGUS to active MM\@.
Further corroborating their hypothesis that GCN2 activation is associated with disease progression in myeloma.
The group then treated a range of MM cell lines with a small molecule, selective GCN2 inhibitor, GCN2iB, which was shown to reduce cell viability\cite{croucher2021longitudinal}.

Saavedra-Garcia et al. (2021) investigated GCN2 inhibition in proteasome inhibition recovery, using time-course multi-omics techniques and GCN2iB cellular assays\cite{saavedra2021systems}.
After one hour pulse treatment of MM cell lines with 750\si{\nano\Molar} carfilzomib (to closely replicate typical clinical PI treatment pharmacokinetics), sequential multiple omic techniques were employed at 0, 1, 2, 4, 6, 8, and 10 day time points.
They found, in-line with previous studies, that levels of most amino acids decreased to below baseline in response to PI treatment, and that GCN2-ATF4 signalling became increasingly reactivated during PI recovery, suggesting a cytoprotective role of the AAR in PI-treated MM cells.
GCN2iB alone was seen to have a moderately inhibitory effect on the proliferation of some MM cell lines.
The addition of GCN2iB had no enhancing effect on carfilzomib-induced cell death at time points 2 and 4 days, however was shown to increase cell death on day 7\cite{saavedra2021systems}.
This demonstrates that GCN2 inhibition disrupts cellular recovery from proteasome inhibition, and that GCN2 signalling may promote the resolution of PI-induced stress in cancer cells.
For the work in this chapter, cells were exposed in culture for 24-72 hours with ProRS inhibitors and/or carfilzomib.
It would be interesting to apply the above group's pulse protocol of PI-treatment to our research, to see if it affects our results.
This could be applied to the ProRS inhibitor-PI synergy investigation (Section \ref{subsec:synergy}), with additional time points up to 7 days, to capture cellular recovery.

We found that mimicking an amino-acid deprived state using ProRS inhibitors, and hence activating GCN2 and the AAR, resulted in anti-MM effects, therefore it is very interesting that other groups found that inhibiting GCN2 and the AAR, also resulted in anti-MM effects.
GCN2-ATF4 AAR signalling is a complex process, which is part of an even more complex cascade of stress responses.
The ISR maintains a fine balance between acting as pro-survival system and as a pro-apoptotic system.
Therefore, it does follow intuitively that exploiting a cancer cell's dependency on this complex stress response, either by activation or inhibition of a key mediator, can have catastrophic effects on the overall cell's survival.

% Stress response clearly complex. Early and late, recovery etc. Push the balance from cyto protective to harmful. Fine balance.
% AAR problems with protecting cell ?

% GCN2 promotes the resolution of PI-induced stress in cancer cells.
% single-cell depiction of tumour progression using the Vκ*MYC model of myeloma
%We suspect that the high level of ISR-GCN2 activity in Vκ*MYC mice with early disease reflects an adaptive mechanism employed by myeloma cells to cope with cellular stress associated with transformation
