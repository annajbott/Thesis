...
From pathway enrichment it is clear that in becoming more resistant to NCP26 and ProRS inhibition, NCP26R cells make transcriptional changes to genes related to ER signalling and amino acid metabolism.
% AAR heatmap NCP26R
\begin{figure}[p]
\centering
...
\end{figure}
%%
Therefore transcriptional changes to the amino acid starvation response were explored.
