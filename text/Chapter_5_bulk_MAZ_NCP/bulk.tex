...
Proline, is the only proteogenic secondary amino acid and has its own metabolic system with its own family of enzymes, distinct from the usual amino acid-metabolising enzymes.
...
Inhibition of PYCR1 with pargyline reduced proline production, MM cell viability and proliferation and increased apoptosis.
...
However, the anti-MM cytotoxic effects seen from ProRS inhibition are far greater than from PYCR1 inhibition as presented by Oudaert et al. (2022).
This could indicate the superiority of the activation of ISR pathways by mimicing complete proline depletion, whereas PYCR1 inhibition only reduces the concentration of proline sourced from P5C, and not dietary proline or the abundance of proline located in pre-existing proteins which can be catabolised by the proteasome.
...
Our findings suggest PYCR1 as new therapeutic target in MM treatment.
