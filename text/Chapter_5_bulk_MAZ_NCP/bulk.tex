...
Cancer has been shown to adapt to therapy, changing its gene expression and genetic make-up to overcome drug treatments.
...
NCP26 has demonstrated strong anti-MM effects, whilst not being susceptible the metabolic liability of a proline supplementation resistance mechanism.
...
The capability of HF and NCP26 to overcome resistance in PI-resistant MM (rather than other MM treatments) was investigated due to the similarities in mechanisms of action of ProRS inhibition and proteasome inhibition.
Proteasome inhibition leads to fewer ubiquitin-tagged proteins being degraded and so misfolded proteins accumulate in the ER lumen.
...
A study from 2012 demonstrated in mammalian cells that treatment with proteasome inhibitors MG-132 and bortezomib depleted the amino acid pool by decreasing the levels of asparagine/aspartate and cysteine to lethal levels.
Supplementation with cysteine and/or asparagine markedly increased cell viability following MG-132/ bortezomib treatment.
MG-132 was shown to induce the ISR using western blots, evident by GCN2 and eIF2$\alpha$ phosphorylation and expression of ATF4, DDIT3 and GADD34.
Cysteine addition mostly abrogated the induction of the ISR resulting MG-132 treatment.
This abrogation of the ISR was demonstrated independent of levels of polyubiquitinated proteins, indicating

Previously its been noted that amino acid deprivation sensitized cancer cells to proteasome inhibition
Then talk about synergy..
Or could talk about other aaRSs and then proline




NCP26 might be better for other diseases too, e.g. scleroderma.
...
PIs affect amino acid pool?? ref 5 in paper
proteasome inhibition results in a lethal amino acid shortage
In mammalian cells, the amino acid scarcity resulting from proteasome inhibition is the signal that causes induction of both the integrated stress response and autophagy, in an unsuccessful attempt to replenish the pool of intracellular amino acids

adaptive changes in MM cell metabolism may provide the basis of resistance to PI- plagarised

Then talk about synergy?? Additive? Maybe affect MRD, double hit against amino acid pool. Cysteine deficient
In mammalian cells, proteasome inhibitors have been shown to deplete the amino acid pool.
For example, Bortezomib treatment decreased the levels of asparagine/aspartate and cysteine.
Supplementation with cysteine and/or asparagine markedly increased cell viability following Bortezomib treatment
