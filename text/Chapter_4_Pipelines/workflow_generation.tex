...
- classifier to automate gene expression profiling and labelling of cells
- limitation = ground truth was user labelled
- Performance = good precision, less good recall.
...
The group investigated the impact of CD138\textsuperscript{+} magnetic bead-based selection compared to whole bone marrow (WBM) processing on BM plasma cell surface markers using flow cytometry\cite{bansal2021impact}.
